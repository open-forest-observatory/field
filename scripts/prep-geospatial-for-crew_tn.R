...
# load convex hulls
plots = st_read(file.path(datadir, "field-plot-locs/teak/teak-flight-polys.gpkg"))
# |>
...
st_write(st_centroid(plots), file.path(datadir, "for-drone-crew/KML/site-points_TN_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_TN_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM_all/TN-all_ellips/TN-all_ellips.tif")
