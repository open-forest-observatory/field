...
# load convex hulls
plots = st_read(file.path(datadir, "field-plot-locs/ca/ca-caldor.gpkg"))
# |>
...
st_write(st_centroid(plots), file.path(datadir, "for-drone-crew/KML/site-points_CA_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_CA_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM_all/CA-all_ellips/CA-all_ellips.tif")
