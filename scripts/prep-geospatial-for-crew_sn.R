...
# load convex hulls
plots = st_read(file.path(datadir, "field-plot-locs/soap/soap-flight-polys.gpkg"))
# |>
...
st_write(st_centroid(plots), file.path(datadir, "for-drone-crew/KML/site-points_SN_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_SN_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM_all/SN-all_ellips/SN-all_ellips.tif")
