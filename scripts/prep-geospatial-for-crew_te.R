...
# load convex hulls
plots = st_read(file.path(datadir, "field-plot-locs/tkef/tkef-flight-polys.gpkg"))
# |>
...
st_write(st_centroid(plots), file.path(datadir, "for-drone-crew/KML/site-points_TE_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_TE_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM_all/TE-all_ellips/TE-all_ellips.tif")
