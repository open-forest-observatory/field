...
# load convex hulls
plots = st_read(file.path(datadir, "field-plot-locs/oh/oh-locs.gpkg"))
# |>
...
st_write(st_centroid(plots), file.path(datadir, "for-drone-crew/KML/site-points_OH_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_OH_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM_all/OH-all_ellips/OH-all_ellips.tif")
