...
# load plot *centers*
plots = st_read(file.path(datadir, "selected-sites-master/site-centers_SS_v1.gpkg"))
...
st_write(plots, file.path(datadir, "for-drone-crew/KML/site-points_SS_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_SS_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM/SS-all_ellips/SS-all_ellips.tif")
