...
# load convex hulls
plots = st_read(file.path(datadir, "field-plot-locs/hs-schatz/hs-flight-polygons.gpkg"))
...
st_write(st_centroid(plots), file.path(datadir, "for-drone-crew/KML/site-points_HS_v1.kml"), delete_dsn = TRUE)
st_write(plots_buff, file.path(datadir, "for-drone-crew/KML/site-polys_HS_v1.kml"), delete_dsn = TRUE)
...
outdir = file.path(datadir, "for-drone-crew/DSM/HS-all_ellips/HS-all_ellips.tif")
